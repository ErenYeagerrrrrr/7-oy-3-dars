      ...
      <section className="animation">
        <div className="animation__block relative" >
          ...
          <div className="animation__block__content absolute bottom-[55px] right-0 left-0 text-white text-center mb-4">
            ...
            <button className="py-[20px] px-[40px] bg-white rounded-[10px] mb-4"><img src="/img/Content.svg" alt="watch" /></button>
          </div>
          <ul className="flex gap-3 mt-4 mx-[30%] items-center">
            <li><button><img src="/img/Group 24.svg" alt="" /></button></li>
            <li><img src="/img/Rectangle 6.svg" alt="" /></li>
            <li><img src="/img/Rectangle 7.png" alt="" /></li>
            <li><img src="/img/Rectangle 8.png" alt="" /></li>
            <li><img src="/img/Rectangle 9.png" alt="" /></li>
            <li><button><img src="/img/Group 23.svg" alt="" /></button></li>
          </ul>
        </div>
      </section>
